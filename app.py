...
winner_counts_df = pd.DataFrame({'Winner': winner.index, 'Count': winner.values})
fig5 = px.bar(data_frame=winner_counts_df, x='Winner', y='Count', color='Count', 
...
if nav=='Score Predictor':
    st.header(':blue[ODI Score Predictor]')
